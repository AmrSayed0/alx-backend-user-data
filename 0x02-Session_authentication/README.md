...
- Overload `def user_id_for_session_id(self, session_id=None):`
  ...
  - Return `None` if the `created_at` + `session_duration` seconds are before the current datetime. [datetime - timedelta](https://alx-intranet.hbtn.io/rltoken/mwc3EnlWLNJ2rvzvgZT8eA "datetime - timedelta")
